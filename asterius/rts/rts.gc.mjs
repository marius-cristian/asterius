      ...
      if (result == undefined) {
        ...
        switch (cur_type) {
          case ClosureTypes.IND: {
            // Whitehole
            this.memory.i64Store(cur_untagged, this.symbolTable.stg_WHITEHOLE_info);
            // Follow the indirectee
            stack.push([Number(this.memory.i64Load(cur_untagged + rtsConstants.offset_StgInd_indirectee)),,,]);
            continue;
          }
          case ClosureTypes.THUNK_SELECTOR: {
            ...
            this.memory.i64Store(cur_untagged, this.symbolTable.stg_WHITEHOLE_info);
            // Follow the selectee
            stack.push([Number(this.memory.i64Load(cur_untagged + rtsConstants.offset_StgSelector_selectee)),,,]);
            continue;
          }
          default: {
            // Switch phase
          ...
          case ClosureTypes.THUNK_SELECTOR: {
            ...
            switch (res_type) {
              ...
              default: {
                ...
                this.memory.i64Store(cur_untagged + rtsConstants.offset_StgSelector_selectee, res_c); 
